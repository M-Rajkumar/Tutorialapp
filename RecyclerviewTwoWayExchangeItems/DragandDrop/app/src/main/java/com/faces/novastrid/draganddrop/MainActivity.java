...
import com.faces.novastrid.draganddrop.databinding.MainActivityBinding;
...
public class MainActivity extends AppCompatActivity implements View.OnDragListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActivityBinding.rcvChooseExercise.addItemDecoration(new SpacesItemDecoration(spacingInPixels));
